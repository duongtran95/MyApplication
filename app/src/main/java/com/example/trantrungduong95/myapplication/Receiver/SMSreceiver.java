package com.example.trantrungduong95.myapplication.Receiver;
...
import com.example.trantrungduong95.myapplication.Spam.SpamFilter;
    ...
    protected void showNotification(Context mContext,String str,String address,String body) {
    	//Display notification...
         ...
         Notification notif = new Notification(
                 R.mipmap.ic_launcher, str/*smsSummary*/,
		...
		notif.flags |= Notification.FLAG_AUTO_CANCEL;
         ...
         //notif.setLatestEventInfo(mContext, "TrueSMS :"+name,body, pi);

		NotificationCompat.Builder builder = new NotificationCompat.Builder(
					mContext);
		notif = builder.setContentIntent(pi)
					.setSmallIcon(R.mipmap.ic_launcher).setTicker("Duong")
					.setAutoCancel(true).setContentTitle(name)
