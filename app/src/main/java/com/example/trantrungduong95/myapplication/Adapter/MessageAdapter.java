...
import com.example.trantrungduong95.myapplication.model.Conversation;
import com.example.trantrungduong95.myapplication.model.Message;
import com.example.trantrungduong95.myapplication.ui.Converter;
import com.example.trantrungduong95.myapplication.ui.MessageProvider;
import com.example.trantrungduong95.myapplication.ui.SmileyParser;
...
public class MessageAdapter extends ResourceCursorAdapter {
    ...
    public MessageAdapter(final MainActivity c, final Uri u) {
    ...
    private static Cursor getCursor(final ContentResolver cr, final Uri u) {
        ...
        try {
            Log.d("where: ", WHERE_DRAFT+ " / sel: "+ Arrays.toString(sel));
    ...
    public final void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        holder.tvDate.setText(Fragment_Conversation.getDate(context, time));
                ...
                public void onClick(final View v) {
                    try {
                        ...
                        if (cn != null) {
                            ...
                            String URI = "content://mms-sms/conversations/";
                ...
                btn.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        try {
                            ...
                            Log.e("activity not found ",i.getAction());
                            Log.e("(text/x-vcard): ",e+"");
